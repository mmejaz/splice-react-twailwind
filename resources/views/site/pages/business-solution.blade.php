    ...
    <span class="text-white">Home - Business Solution</span>
      ...
      <section class="py-20 bg-white">
         <div class="flex flex-col px-8 mx-auto space-y-12 max-w-7xl xl:px-12">
            <div class="relative">
               <h2 class="w-full text-3xl font-bold text-center sm:text-4xl md:text-5xl"> Business Solution</h2>
               <p class="w-full py-8 mx-auto -mt-2 text-lg text-center text-gray-700 intro sm:max-w-3xl">We at Splice Packages strive to become the number 1 US shipping partner for business start-ups as well as for established firms around the globe. We have listed below the benefits and How Splice Packages helps you in your business growth.</p>
            </div>
            <div class="flex flex-col mb-8 animated fadeIn sm:flex-row">
               <div class="flex items-center mb-8 sm:w-1/2 md:w-5/12 sm:order-last">
                  <img class="rounded-lg shadow-xl" src="https://splicepackages.com/public/presentation/splice-business-growth-graph.jpg" alt="">
               </div>
               <div class="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pr-16">
                  <p class="mb-2 text-sm font-semibold leading-none text-left text-sp-orange uppercase">Drag-n-drop design</p>
                  <h3 class="mt-2 text-2xl sm:text-left md:text-4xl">How It All Works?</h3>
                  <p class="mt-5  text-gray-700 text md:text-left text-md lg:text-justify">Are you a Big Business Vendor and want to grow your business? Splice Packages provide an easy solution for all such business vendors for their market expansion. Send your packages to your customers around the globe, on the go. With Splice Packages, you will get dedicated warehouse storage according to your business needs. Moreover, with our unique feature of the customized dashboard, you can manage all your business needs, such as sending a package to your customers anywhere in the world anytime without any trouble.</p>
               </div>
            </div>
            <div class="flex flex-col mb-8 animated fadeIn sm:flex-row">
               <div class="flex items-center mb-8 sm:w-1/2 md:w-5/12">
                  <img class="rounded-lg shadow-xl" src="https://splicepackages.com/public/presentation/splice-warehouse.jpg" alt="">
               </div>
               <div class="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pl-16">
                  <p class="mb-2 text-sm font-semibold leading-none text-left text-sp-orange uppercase">Shipping Rates</p>
                  <h3 class="mt-2 text-2xl sm:text-left md:text-4xl">Streamlined Workflow</h3>
                  <p class="mt-5 text-md text-gray-700 text md:text-left lg:text-justify">With our specialized operations design, there are never any bottlenecks in the processing of your mail and parcel forwarding in USA. You can rely on our efficient services for your shipments to be delivered on schedule 99% of the time.</p>
                  <p class="mt-5 text-md text-gray-700 text md:text-left lg:text-justify"><strong>Best International Shipping Rates:</strong> By registering for a premium membership with Splice Packages, we ensure that you are getting the best international shipping rates.</p>
               </div>
            </div>
            <div class="flex flex-col mb-8 animated fadeIn sm:flex-row">
               <div class="flex items-center mb-8 sm:w-1/2 md:w-5/12 sm:order-last">
...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="grid md:grid-cols-2 items-center gap-12">
    <div>
      ...
      <div class="mt-8">
        ...
        <ul class="mt-2 space-y-2">
          <li class="flex space-x-3">
            <svg class="flex-shrink-0 mt-0.5 size-5 text-gray-600 dark:text-neutral-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
      ...
      <div class="mt-10 flex items-center gap-x-5">
        ...
        <div class="flex -space-x-2">
          <img class="inline-block size-8 rounded-full ring-2 ring-white dark:ring-neutral-900" src="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=320&h=320&q=80" alt="Image Description">
          <img class="inline-block size-8 rounded-full ring-2 ring-white dark:ring-neutral-900" src="https://images.unsplash.com/photo-1531927557220-a9e23c1e4794?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2.5&w=320&h=320&q=80" alt="Image Description">
          <img class="inline-block size-8 rounded-full ring-2 ring-white dark:ring-neutral-900" src="https://images.unsplash.com/photo-1541101767792-f9b2b1c4f127?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=3&w=320&h=320&q=80" alt="Image Description">
    ...
    <div class="relative">
      <!-- Card -->
      <div class="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-10 dark:border-neutral-700 sp-border">
