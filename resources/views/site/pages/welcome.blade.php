      ...
      <div class="relative h-56 overflow-hidden  md:h-[550px]">
         ...
         <div class="hidden duration-700 ease-in-out" data-carousel-item>
            ...
            <div class="relative p-4 text-white z-10 flex items-center h-full left-16">
               <div>
                  <h1 class="font-bold text-3xl"><span>FAST AND RELIABLE</span><br/><span class="text-sp-orange">PACKAGE FORWARDING SERVICES</span></h1>
                  </br>
                  <p>If You Can Bring It, <span class="text-sp-orange">We Can Ship It.</span><br/>
                     ...
                     <button class="bg-sp-orange hover:bg-blue-700 text-white py-2 px-4 rounded mt-5">
                     Login
                     </button>
                  </p>
                  </br>
         ...
         <div class="hidden duration-700 ease-in-out" data-carousel-item>
            ...
            <div class="relative p-4 text-white z-10 flex items-center h-full left-16">
               <div>
                  <h2 class="text-3xl font-bold"><span>EXPERIENCE EASY</span><br/><span class="text-sp-orange">FREIGHT FORWARDING SERVICES</span></h2>
                  </br>
                  <p>Tell Us What You Love And We’ll Shop For You<br/>
                     Shop and Ship process is easy now with Splice Packages.<br/>
                     If your online payment method is not acceptable,<br/>
                     We can place an order on your behalf from any online
                     store in the USA.
                  </p>
                  </br>
                  <button class="bg-sp-orange hover:bg-blue-700 text-white py-2 px-4 rounded mt-5 mr-2">
                  Login
                  </button>
                  <button class="bg-sp-orange hover:bg-blue-700 text-white py-2 px-4 rounded mt-5 ">
                  SignUp
   ...
   <div id="cookies-with-stacked-buttons" class="fixed bottom-0 end-0 z-[60] sm:max-w-sm w-full mx-auto p-6">
      ...
      <div class="p-4 bg-white/60 backdrop-blur-lg rounded-xl shadow-2xl dark:bg-neutral-900/60 dark:shadow-black/70">
         ...
         <p class="mt-2 text-sm text-gray-800 dark:text-neutral-200">
            We use cookies to improve your experience and for marketing. Visit our <a class="inline-flex items-center gap-x-1.5 text-blue-600 decoration-2 hover:underline font-medium dark:text-blue-500" href="#">Cookies Policy</a> to learn more.
         </p>
         <div class="mt-5 mb-2 w-full flex gap-x-2">
            <div class="grid w-full">
               <button type="button" class="py-2 px-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
               Allow all
               </button>
            </div>
            <div class="grid w-full">
