...
<section id="splice-packages-hero-section">
   <div class="bg-white relative pt-40 pb-20 lg:pt-32 dark:bg-gray-900">
      <div class="relative max-w-screen-xl mx-auto px-6 md:px-12 lg:px-6">
         <h1 class="sm:mx-auto sm:w-10/12 md:w-2/3 font-black text-[#13224d] text-4xl text-center sm:text-5xl md:text-6xl lg:w-auto lg:text-left xl:text-5xl dark:text-white">MAIL AND PACKAGE 
            <br class="lg:block hidden"> <span class="relative text-transparent bg-clip-text bg-gradient-to-r from-sp-orange to-sp-orange dark:from-blue-400 dark:to-cyan-300">FORWARDING COMPANY</span>.
         </h1>
         <div class="lg:flex flex-wrap">
            <div class="relative mt-4 md:mt-8 space-y-4 sm:w-10/12 md:w-2/3 lg:ml-0 sm:mx-auto text-center lg:text-left lg:mr-auto lg:w-7/12">
               <p class="sm:text-lg text-gray-700 dark:text-gray-300 lg:w-11/12">
                  Shop From USA And Ship Worldwide
                  Shipping your favorite purchased items all the way from USA
                  to your doorstep.
                  No matter what your package always comes first. Shop now your favorite
                  products from USA online stores and receive your packages at
                  your home address <br/>anywhere in the world.
               </p>
               <span class="block font-semibold text-gray-500 dark:text-gray-400">The best USA Stores.</span>
               <div class="grid grid-cols-3 space-x-4 md:space-x-6 md:flex md:justify-center lg:justify-start">
                  <a aria-label="add to slack" href="#" class="p-4 border border-gray-200 dark:bg-gray-800 dark:border-gray-700 rounded-full duration-300 hover:border-cyan-400 hover:shadow-lg hover:shadow-cyan-600/20 dark:hover:border-cyan-300/30">
                     <div class="flex justify-center space-x-4">
                        <img class="w-6 h-6" src="https://splicepackages.com/public/presentation/images/index/Pics/apple.svg" alt="slack logo" loading="lazy" width="128" height="128">
                        <span class="hidden font-medium md:block dark:text-white">Apple</span>
                     </div>
                  </a>
                  <a aria-label="add to chat" href="#" class="p-4 border border-gray-200 dark:bg-gray-800  dark:border-gray-700 rounded-full duration-300 hover:border-green-400 hover:shadow-lg hover:shadow-lime-600/20 dark:hover:border-green-300/30">
                     <div class="flex justify-center space-x-4">
                        <img class="w-6 h-6" src="https://splicepackages.com/public/presentation/images/index/Pics/puma.svg" alt="chat logo" loading="lazy" width="128" height="128">
                        <span class="hidden font-medium md:block dark:text-white">Puma</span>
                     </div>
                  </a>
                  <a aria-label="add to zoom" href="#" class="p-4 border border-gray-200 dark:bg-gray-800  dark:border-gray-700 rounded-full duration-300 hover:border-blue-400 hover:shadow-lg hover:shadow-blue-600/20 dark:hover:border-blue-300/30">
                     <div class="flex justify-center space-x-4">
                        <img class="w-6 h-6" src="https://splicepackages.com/public/presentation/images/index/Pics/Nike.svg" alt="chat logo" loading="lazy" width="128" height="128">
                        <span class="hidden font-medium md:block dark:text-white">Nike</span>
                     </div>
                  </a>
               </div>
               <div class="dark:text-gray-300">
                  💖
                  <span>The best companion bot for your package.</span> 
               ...
               <div class="pt-12 flex gap-6 lg:gap-12 justify-between  lg:w-2/3">
                  <img src="{{asset('site/carriers/ups-united-parcel-service.svg')}}" class="h-8 sm:h-10 w-auto lg:h-14" alt="" />
                  <img src="{{asset('site/carriers/united-states-postal-service-logo.svg')}}" class="h-8 sm:h-10 w-32 lg:h-16" alt="" />
                  <img src="{{asset('site/carriers/aramex-logo-1.svg')}}" class="h-8 sm:h-10 w-32 lg:h-16" alt="" />
                  <img src="{{asset('site/carriers/dhl-logo-1.svg')}}" class="h-8 sm:h-10 w-32 lg:h-12" alt="" />
                  <img src="{{asset('site/carriers/fedex-express-6.svg')}}" class="h-8 sm:h-10 w-28 lg:h-10" alt="" />
               </div>
            </div>
            <div class="mt-12 md:mt-0 lg:absolute -right-10 lg:w-4/12">
         ...
         <div class="overflow-hidden bg-white shadow-xl dark:bg-gray-800 sm:rounded-lg">
            <div>
               <div class="p-6 bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 sm:px-20">
                  ...
                  <div class="mt-6 text-gray-500 dark:text-gray-400"> Splice Packages offers a solution to your every shopping and shipping need from the USA including, Repacking, Consolidation,
            ...
            <div class="relative p-6 space-y-6 lg:p-8 ">
               ...
               <div class="flex items-center justify-center mt-8">
                  <button @click="
                     ...
                     premiumPrice = '29',
                     proPrice = '39'
                     " class="px-4 py-2 rounded-tl-lg rounded-bl-lg bg-sp-orange text-white"  title="Choose Monthly billing">
                  Premium Service
                  </button>
                  <button @click="
                     billingType = 'year',
               ...
               <div>
                  <div class="relative flex justify-around">
                     <div class="flex items-end">
                        <span class="text-8xl text-gray-800 font-bold leading-0">80</span>
                        <div class="pb-2">
               ...
               <p class="flex items-center justify-center space-x-4 text-lg text-gray-600 text-center">
                  ...
                  <a href="tel:+24300" class="flex space-x-2 items-center text-sp-orange">
                     ...
                     <span class="font-semibold">+1 (904) 656-1066</span>
                  </a>
                  <span>or</span>
               </p>
...
<div class="py-16 bg-gray-50 overflow-hidden">
   <div class="container m-auto px-6 space-y-8 text-gray-500 md:px-12">
      <div>
         <span class="text-gray-600 text-lg font-semibold">Easy Steps</span>
         <h2 class="mt-4 text-2xl text-gray-900 font-bold md:text-4xl">HOW TO SHOP & SHIP  <br class="lg:block" hidden> FROM USA</h2>
      </div>
