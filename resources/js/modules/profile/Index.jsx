...
import { Card, Col, Row, Tabs, Form, Input, Select, Button, message, Upload, Switch } from "antd";
import {
    SettingOutlined,
    UserOutlined,
    LockOutlined,
  ...
  const onChangeChecked = (checked) => {
    ...
    return (
        <>
            ...
            <Row gutter={[16, 16]} className="flex justify-start mt-5 profile-tab">
            ...
            <Row gutter={[16, 16]} className="flex justify-start mt-5">
                <Col xs={24} sm={24} md={24} lg={24} className="pl-2">
                    {activeKey === "1" && (
                        <Row gutter={16}>
                    ...
                    {activeKey === "2" && (
                        <Row gutter={16}>
                          <Col xs={24} sm={24} md={24} lg={24} className="general-card">
                            ...
                            >
                              <Row gutter={16}>
                                <Col span={6} className="upload-file">
                                    <div className="font-semibold mb-2">Company Logo</div>
                                    {/* <Input className="rounded" placeholder="Splice logo.jpeg" /> */}
                                    <Upload {...props}>
                                        <Button className="w-[100%] h-[42px]" icon={<UploadOutlined />}>Click to Upload</Button>
                                    </Upload>
                                </Col>
                                <Col span={6}>
                                    <div className="font-semibold mb-2 flex">Contact Email <Switch className="ml-2" defaultChecked onChange={onChangeChecked} /></div>
                                    <Input className="rounded" placeholder="support@gmail.com" />
                                </Col>
                                <Col span={6}>
                                    <div className="font-semibold mb-2 flex">Phone No. <Switch className="ml-2" defaultChecked onChange={onChangeChecked} /></div>
                                    <Input className="rounded" placeholder="+1 (904) 783-3283" />
                                </Col>
                                <Col span={6}>
                                    <div className="font-semibold mb-2 flex">Whatsapp No. <Switch className="ml-2" defaultChecked onChange={onChangeChecked} /></div>
                                    <Input className="rounded" placeholder="+1 (904) 783-3283" />
                                </Col>
                              </Row>
                              <Row gutter={16} className="mt-5">
                                <Col span={12}>
                                      <div className="font-semibold mb-2 flex">Business Hours <Switch className="ml-2" defaultChecked onChange={onChangeChecked} /></div>
