...
import { Drawer, Form, Button, Col, Row, Input, Select, message, Upload, Table, Checkbox} from "antd";
    ...
    return (
        ...
        >
            <Form layout="vertical" hideRequiredMark className="packages-form" onFinish={handleFinish}>
                ...
                <Row gutter={16}>
                    <Col span={24} className="drawer-table">
                        <Table className="packages-table text-center" dataSource={dataSource} columns={columns} />
                    </Col>
                </Row>
                <Row gutter={16} className="mt-4">
                    <Col span={24}>
                        <Form.Item
                            name="comments"
                            label={<span className="text-white">Comment or Special Instructions</span>}
                            rules={[{ required: true, message: 'Please enter TComments' }]}
                        >
                            <TextArea className="bg-transparent border input-border text-white" placeholder="Write you text here..."  rows={4} />
                        </Form.Item>
                    </Col>
                </Row>
                <Row gutter={16} className="mt-4">
                    <Col span={24}>
                        <Form.Item>
                            <Button className="mr-3 border-0 text-white button-submit rounded-none" htmlType="submit">
                                Submit
                            </Button>
                            <Button type="default" className="border-0 text-white button-clear rounded-none" onClick={onClose}>
                                Clear
                            </Button>
                        </Form.Item>
                    </Col>
